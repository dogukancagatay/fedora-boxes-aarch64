...
network --device eth0 --bootproto dhcp --noipv6 --hostname=fedora37b.localdomain
...
url --url=https://dl.fedoraproject.org/pub/fedora/linux/development/37/Server/aarch64/os/
# url --url=https://mirrors.edge.kernel.org/fedora/development/37/Everything/aarch64/os/
# url --url=https://archives.fedoraproject.org/pub/archive/fedora/linux/releases/37/Everything/aarch64/os/
