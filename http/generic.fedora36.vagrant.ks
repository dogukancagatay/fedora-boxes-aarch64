...
# url --url=https://mirrors.edge.kernel.org/fedora/releases/36/Everything/aarch64/os/
# url --url=https://archives.fedoraproject.org/pub/archive/fedora/linux/releases/36/Everything/aarch64/os/
