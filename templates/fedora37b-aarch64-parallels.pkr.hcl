source "parallels-iso" "generic-fedora37b-aarch64-parallels" {
  ...
  memory                     = 2048
  disk_size                  = 32768
  iso_checksum               = "file:https://dl.fedoraproject.org/pub/fedora/linux/development/37/Server/aarch64/iso/Fedora-Server-37-aarch64-20221110.n.0-CHECKSUM"
  iso_url                    = "https://dl.fedoraproject.org/pub/fedora/linux/development/37/Server/aarch64/iso/Fedora-Server-netinst-aarch64-37-20221110.n.0.iso"
