...
network --device eth0 --bootproto dhcp --noipv6 --hostname=fedora${fedora_version}.localdomain
...
# url --url=https://dl.fedoraproject.org/pub/archive/fedora/linux/releases/${fedora_version}/Everything/aarch64/os/
